...
?>
  <div class="container">
    ...
    <form id="create-form" action="<?= $BASE_URL ?>config/process.php" method="POST">
      ...
      <div class="form-group">
        <label for="phone">Convidados</label>
        <input type="text" class="form-control" id="convidados" name="convidados" placeholder="Digite o número de convidados" value="<?= $contact['phone'] ?>" required>
      </div>
      <div class="form-group">
